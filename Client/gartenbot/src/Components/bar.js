                ...
                <ul className="flex flex-col py-4 space-y-2">
                    ...
                    <li>
                        <a className="relative flex flex-row items-center h-11 focus:outline-none  border-l-4 border-transparent   pr-6">
                            ...
                            <span className="ml-2 justify-center hidden 2xl:block  text-sm tracking-wide truncate">Verbrauch: </span>
                            <span className={`ml-2 hidden 2xl:block text-sm tracking-wide truncate ${drain === "Hoch" ? "text-red-400" : ""}${drain === "Mittel" ? "text-yellow-400" : ""}${drain === "Niedrig" ? "text-green-400" : ""}`}>{drain}</span>
                        </a>
